...
import 'ai_snippet_chat_view.dart';
...
class _SnippetsScreenState extends ConsumerState<SnippetsScreen> {
  String _searchQuery = '';
  int _activeTabIndex = 0; // 0: Library, 1: AI Assistant
              ...
              child: SegmentedButton<int>(
                segments: [
                  ...
                  ButtonSegment<int>(
                    ...
                    label: Text(
                      context.tr(
                        'snippets.tab_ai_assistant',
                        defaultText: 'AI Assistant',
                      ),
                    ),
                ...
                onSelectionChanged: (val) {
                  setState(() => _activeTabIndex = val.first);
                },
                style: ButtonStyle(
                  visualDensity: VisualDensity.compact,
                  backgroundColor: WidgetStateProperty.resolveWith((states) {
                    if (states.contains(WidgetState.selected)) {
                      return ShellitColors.accentBlue.withValues(alpha: 0.25);
                    }
                    return ShellitColors.obsidianCard;
                  }),
                  foregroundColor: WidgetStateProperty.resolveWith((states) {
                    if (states.contains(WidgetState.selected)) {
                      return ShellitColors.accentCyan;
                    }
                    return ShellitColors.textSecondary;
                  }),
                          ...
                          data: (snippets) {
                            final filtered = snippets.where((s) {
                              ...
                              return s.title.toLowerCase().contains(
                                  ...
                                  s.command.toLowerCase().contains(
                                    _searchQuery,
                                  ) ||
                                  s.tags.any(
                                    (t) =>
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      snippets.isEmpty
                                          ? context.tr(
                                              'snippets.empty_title',
                                              defaultText:
                                                  'No Snippets Saved Yet',
                                            )
                                          : context
                                                .tr(
                                                  'snippets.empty_match',
                                                  defaultText:
                                    ...
                                    if (snippets.isEmpty) ...[
                                      ...
                                      OutlinedButton.icon(
                                        ...
                                        label: Text(
                                          context.tr(
                                            'snippets.btn_add_first',
                                            defaultText: 'Add First Snippet',
                                          ),
                                        ),
                                        onPressed: () =>
                                            _showEditSnippetDialog(context),
                                      ),
                                    ],
                                  ],
                                ),
                                              ...
                                              Tooltip(
                                                message: context
                                                    .tr(
                                                      ...
                                                      defaultText:
                                                          'Execute in active terminal ({tab})',
                                                    )
                                                    .replaceAll(
                                                      '{tab}',
                                                      activeTab!.title,
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(
          isEditing
              ? context.tr(
                  'snippets.dialog_edit_title',
                  defaultText: 'Edit Snippet',
                )
              : context.tr(
                  'snippets.dialog_new_title',
                  defaultText: 'New Command Snippet',
                ),
          style: const TextStyle(
            color: ShellitColors.textPrimary,
            fontSize: 16,
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: context.tr(
                      'snippets.command_field',
                      defaultText: 'Command / Script',
                    ),
