...
Shellit был спроектирован, написан и оттестирован с нуля за **менее чем 24 часа** (~19 часов чистого времени активного вайб-кодинга с ИИ-агентами): от пустой папки до полноценного кроссплатформенного приложения с собственной E2EE-синхронизацией, MCP-шлюзом и ИИ-ассистентом Gemini.
